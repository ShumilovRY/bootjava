...
@Tag(name = "User Restaurant Controller", description = "Getting a restaurant by a user with item votes.")
public class RestaurantController {
    public static final String RESTAURANTS_REST_URL = "/api/restaurants/with-votes";
